...
public class userLoginF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 340, 140, 30));
        ...
        p_edit.add(jLabel17);
        jLabel17.setBounds(30, 10, 70, 20);

        jPanel1.add(p_edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 140, 30));

        acc_id.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        acc_id.setText("ID");
        jPanel1.add(acc_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 370, 140, 30));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 20, 60, 20));
      ...
      if(rowIndex < 0){
          ...
          try{
              ...
              if(rs.next()){
                  ...
                  usf.um.setSelectedItem(""+rs.getString("u_status"));
    ...
    public javax.swing.JTable usersOnly;
